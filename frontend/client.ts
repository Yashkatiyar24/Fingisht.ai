...
export function Environment(name: string): BaseURL {
    return `https://${name}-smart-expense-dashboard-i542.encr.app`
}
...
/**
 * Client is an API client for the smart-expense-dashboard-i542 Encore application.
 */
export class Client {
 ...
 * Import the endpoint handlers to derive the types for the client.
 */
import { create as api_budget_create_create } from "~backend/budget/create";
import { list as api_budget_list_list } from "~backend/budget/list";
...
export namespace budget {
    ...
    export class ServiceClient {
         ...
         */
        public async create(params: RequestType<typeof api_budget_create_create>): Promise<ResponseType<typeof api_budget_create_create>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/budgets`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_budget_create_create>
        }

        /**
         * Lists all budgets with current spending
         */
        public async list(): Promise<ResponseType<typeof api_budget_list_list>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/budgets`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_budget_list_list>
        }
    }
}
...
import {
    createRule as api_category_rules_createRule,
    listRules as api_category_rules_listRules
} from "~backend/category/rules";
...
export namespace category {
    ...
    export class ServiceClient {
         ...
         */
        public async createRule(params: RequestType<typeof api_category_rules_createRule>): Promise<ResponseType<typeof api_category_rules_createRule>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/categories/rules`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_category_rules_createRule>
        }
         ...
         */
        public async listRules(): Promise<ResponseType<typeof api_category_rules_listRules>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/categories/rules`, {method: "GET", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_category_rules_listRules>
        }
    }
}
...
import { deleteTransaction as api_transaction_delete_deleteTransaction } from "~backend/transaction/delete";
import { importTransactions as api_transaction_import_importTransactions } from "~backend/transaction/import";
import { list as api_transaction_list_list } from "~backend/transaction/list";
import { update as api_transaction_update_update } from "~backend/transaction/update";
...
export namespace transaction {
    ...
    export class ServiceClient {
        ...
        public async importTransactions(params: RequestType<typeof api_transaction_import_importTransactions>): Promise<ResponseType<typeof api_transaction_import_importTransactions>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/transactions/import`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_transaction_import_importTransactions>
        }

        /**
         * Lists transactions with optional filters
         */
        public async list(params: RequestType<typeof api_transaction_list_list>): Promise<ResponseType<typeof api_transaction_list_list>> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_transaction_list_list>
        }

        /**
         * Updates an existing transaction
         */
        public async update(params: RequestType<typeof api_transaction_update_update>): Promise<ResponseType<typeof api_transaction_update_update>> {
            // Construct the body with only the fields which we want encoded within the body (excluding query string or header fields)
            const body: Record<string, any> = {
            ...
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_transaction_update_update>
        }
    }
}
 ...
 */
import {
    getUploadUrl as api_upload_upload_getUploadUrl,
    processUpload as api_upload_upload_processUpload
} from "~backend/upload/upload";
...
export namespace upload {
    ...
    export class ServiceClient {
         ...
         */
        public async getUploadUrl(params: RequestType<typeof api_upload_upload_getUploadUrl>): Promise<ResponseType<typeof api_upload_upload_getUploadUrl>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/upload/url`, {method: "POST", body: JSON.stringify(params)})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_upload_upload_getUploadUrl>
        }

        /**
         * Processes an uploaded CSV file
         */
        public async processUpload(params: { uploadId: number }): Promise<ResponseType<typeof api_upload_upload_processUpload>> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI(`/upload/${encodeURIComponent(params.uploadId)}/process`, {method: "POST", body: undefined})
            return JSON.parse(await resp.text(), dateReviver) as ResponseType<typeof api_upload_upload_processUpload>
        }
    }
}
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "smart-expense-dashboard-i542-Generated-TS-Client (Encore/v1.50.6)";
        }
